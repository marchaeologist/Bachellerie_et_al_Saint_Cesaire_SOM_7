...
The bearing can be converted into an orientation in the interval [0;180] by subtracting 180° from the measurements belonging to the interval [180;360].
...
The SU 18 spits in the upslope (K4 III-IV, J4 III-IV) and downslope areas (K5 IV, K5 III-IV) tend to cluster in or near the zone of experimental reduction sequences in all the sub-squares (fig. S7-\ref{fig:granulo}).
